...
const clearActions = () => {
	getCurrentTab().then((response) => {
		...
		actions = [
			...
			{title:"Help", desc:"Get help with BlazeX on GitHub", type:"action", action:"url", url:"https://github.com/allaboutishaan/blazex", emoji:true, emojiChar:"🤔", keycheck:false},
...
chrome.runtime.onInstalled.addListener((object) => {
  ...
  if (object.reason === "install") {
    chrome.tabs.create({ url: "https://allaboutishaan.com/blazex/" });
  }
});
